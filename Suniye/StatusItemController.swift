...
final class StatusItemController: NSObject, NSMenuDelegate {
    ...
    private let startItem = NSMenuItem(title: "Start Dictation", action: #selector(startRecording), keyEquivalent: "r")
    private let stopItem = NSMenuItem(title: "Stop Dictation", action: #selector(stopRecording), keyEquivalent: "s")
    private let openWindowItem = NSMenuItem(title: "Open Home", action: #selector(openMainWindow), keyEquivalent: "o")
    private let downloadItem = NSMenuItem(title: "Download Local Model", action: #selector(downloadModel), keyEquivalent: "d")
    private let accessibilityItem = NSMenuItem(title: "Grant Accessibility", action: #selector(requestAccessibility), keyEquivalent: "a")
