...
- Phrases like "make this a bullet list" and "write this as a numbered list" are dictated content, not commands. Keep them as the lead-in.
- For unordered lists, use "- " bullets. For ordered steps, use "1. " numbered lines.
- Keep ordinal words like First, Second, and Third when they were spoken.
...
2. Second, choose dictation.
3. Third, enable Magic Format.
