...
final class AppStateSettingsTests: XCTestCase {
    ...
    func testManualIndicatorToggleStartsRecordingFromReady() async {
        ...
        XCTAssertEqual(
            ...
            .listening(levels: Array(repeating: 0, count: AudioLevelMeter.bandCount), source: .manual, preview: .pending)
        )
    }
    ...
    func testHotkeyCallbacksStillDriveRecordingWhenRuntimeServicesEnabled() async {
        ...
        XCTAssertEqual(
            appState.floatingIndicatorState,
            .listening(levels: Array(repeating: 0, count: AudioLevelMeter.bandCount), source: .hotkey, preview: .pending)
        )
